...
namespace NetPrints.Tests
{
    ...
    public class ClassTranslatorTests
    {
        ...
        public void CreateStringLengthMethod()
        {
            ...
            // Create nodes
            VariableGetterNode getStringNode = new(stringLengthMethod, new VariableSpecifier("testVariable", stringType, MemberVisibility.Public, MemberVisibility.Public, stringType, VariableModifiers.None));
            VariableGetterNode getLengthNode = new(stringLengthMethod, new VariableSpecifier("Length", intType, MemberVisibility.Public, MemberVisibility.Public, stringType, VariableModifiers.None));
        ...
        public void CreateMainMethod()
        {
            ...
            MethodSpecifier stringLengthSpecifier = new("StringLength", new MethodParameter[0], new List<TypeSpecifier>() { TypeSpecifier.FromType<int>() },
            ...
            TypeSpecifier stringType = TypeSpecifier.FromType<string>();
            MethodSpecifier writeConsoleSpecifier = new("WriteLine", new MethodParameter[] { new MethodParameter("argName", stringType, MethodParameterPassType.Default, false, null) }, new BaseType[0],
            ...
            VariableSetterNode setStringNode = new(mainMethod, new VariableSpecifier("testVariable", TypeSpecifier.FromType<string>(), MemberVisibility.Public, MemberVisibility.Public, cls.Type, VariableModifiers.None));
            CallMethodNode getStringLengthNode = new(mainMethod, stringLengthSpecifier);
            CallMethodNode writeConsoleNode = new(mainMethod, writeConsoleSpecifier);
