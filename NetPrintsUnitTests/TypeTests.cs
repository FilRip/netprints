...
namespace NetPrintsUnitTests
{
    ...
    public class TypeTests
    {
        ...
        {
            TypeSpecifier typeA = new("TypeA");
            TypeSpecifier typeB = new("TypeB");
            TypeSpecifier sameAsTypeA = new("TypeA");
        ...
        {
            TypeSpecifier typeA = new("TypeA", false, false, new BaseType[] { });
            GenericType genType1 = new("T1");
            GenericType genType2 = new("T2");
